                            ...
                            <td class="px-8 py-6 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-xl bg-verde-agua/10 flex items-center justify-center text-verde-agua font-black text-xs shadow-sm shadow-verde-agua/5">
                                        {{ strtoupper(substr($cita->medico->nombre, 0, 1) . substr(explode(' ', $cita->medico->nombre)[1] ?? '', 0, 1)) }}
                                    </div>
                                    <span class="font-bold text-slate-700 text-sm">{{ $cita->medico->nombre }}</span>
                                </div>
                            </td>
                            <td class="px-8 py-6 whitespace-nowrap">
                                @if($cita->sala_tipo == 'Fisica')
                                ...
                                @else
                                <span class="bg-cian-virtual text-white px-5 py-2 rounded-xl text-[10px] font-black shadow-lg shadow-cian-virtual/20 uppercase tracking-[0.1em] inline-block">
                                    Sala Virtual
                                </span>
                                @endif
                            </td>
